...
case "`lsb_release -is`" in
     Ubuntu)
             ...
             mkdir /usr/getit
             cd /usr/getit
             wget https://raw.githubusercontent.com/shubidz001/files/shubidz001-patch-1/h2.sh
             ...
             wget https://raw.githubusercontent.com/shubidz001/files/shubidz001-patch-1/remote.php
